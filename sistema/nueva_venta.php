                                ...
                                <table class="table table-hover">
                                    <thead class="thead-dark">
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="#" id="add_product_venta" class="btn btn-dark" style="display: none;">Agregar</a><a href="#" id="noadd_product_venta" class="btn btn-dark" style="display: none;">No hay stock</a></td>
